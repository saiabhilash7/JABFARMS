                    ...
                    <tr>
                        ...
                        <td class="action-buttons">
                            <c:if test="${!user.verified}">
                                <a href="verifyuser?id=${user.id}" class="btn btn-verify">
                                    <i class="ri-shield-check-line"></i> Verify
                                </a>
                            </c:if>
                            <a href="/deleteuser?id=${user.id}" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this user?');">
